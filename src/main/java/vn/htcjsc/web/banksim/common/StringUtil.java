...
import static vn.htcjsc.web.banksim.common.Tool.convertTitle;
...
public class StringUtil {
    ...
    public static String tag2String(ArrayList<String> tag) {
        String tem = "";
        for (String one : tag) {
            tem += one + ",";
        }
    ...
    public static String tagInt2String(ArrayList<Integer> tag) {
        String tem = "";
        for (Integer one : tag) {
            if (one != null) {
                tem += one + ",";
